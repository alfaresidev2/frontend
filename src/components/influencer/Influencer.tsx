    ...
    const handleCategoryKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
        if (e.key === 'ArrowDown') {
            ...
            setSelectedCategoryIndex(prev => 
                prev < suggestedCategories.length - 1 ? prev + 1 : prev
            );
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            {influencer.updates?.welcomeMailWithPasswordSent ? (
                                                <span
                                                    className="px-2 py-1 text-xs font-medium text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/40 rounded-full"
                                                >
                                                    Sent
                                                </span>
                                            ) : (
                                ...
                                >
                                    <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                                        ...
                                        >
                                            ...
                                            <div>
                                                <label htmlFor="phoneNumber" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">
                                        ...
                                        <motion.div variants={itemVariants}>
                                            <div>
                                                <label htmlFor="bio" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">
                                        ...
                                        <motion.div variants={itemVariants}>
                                            <div>
                                                ...
                                                {platforms.map((platform, index) => (
                                                    <div 
                                                        key={index} 
                                                        className="space-y-4 mb-6 transition-transform hover:scale-[1.02]"
                                                    >
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-2 gap-4 text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="font-medium text-gray-900 dark:text-gray-200">{currentInfluencer.phoneNumber}</p>
                                                </div>
                                                <div>
                                                    <p className="text-gray-600 dark:text-gray-400">Gender</p>
                                                    <p className="font-medium text-gray-900 dark:text-gray-200 capitalize">{currentInfluencer.gender}</p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="space-y-4">
                                                {filePreview.photos.length > 0 && (
                                                    <div>
                                                        ...
                                                        <div className="grid grid-cols-3 gap-3">
                                                            {filePreview.photos.map((photo) => (
                                                                <div key={photo.id} className="relative aspect-square rounded-lg overflow-hidden bg-gray-50">
                                                                    <Image
                                                                        src={photo.url}
                                                                        alt="Preview"
                                                                        fill
                                                ...
                                                {filePreview.videos.length > 0 && (
                                                    <div>
                                                        ...
                                                        <div className="grid grid-cols-3 gap-3">
                                                            {filePreview.videos.map((video) => (
                                                                <div key={video.id} className="relative aspect-square rounded-lg overflow-hidden bg-gray-50">
                                                                    <video
                                                                        src={video.url}
                                                                        className="absolute inset-0 w-full h-full object-cover"
                                                                        controls
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="py-4">
                                    <p className="text-gray-600 dark:text-gray-400">
                                        Would you like to send the login credentials to <span className="font-medium text-gray-900 dark:text-gray-200">{currentInfluencer?.email}</span>?
                                    </p>
                                </div>
